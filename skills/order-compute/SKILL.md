...
```sh
npx --yes @celo/buy@0.6.0 setup --name demo
```
...
```sh
npx --yes @celo/buy@0.6.0 account cap demo 1.00
```
...
```sh
npx --yes @celo/buy@0.6.0 mcp install --client all
```
...
```sh
npx --yes @celo/buy@0.6.0 verify hosted \
...
(
  ...
  npx --yes @celo/buy@0.6.0 --verbose curl --max-amount 0.02 \
    -X POST \
...
```sh
npx --yes @celo/buy@0.6.0 --verbose curl --max-amount 0.07 \
  -X POST \
...
`npx --yes @celo/buy@0.6.0 receipts`). It shows the time, target URL, amount, and network,
